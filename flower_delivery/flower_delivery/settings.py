...
SECRET_KEY = 'django-insecure-c(0h)(za6l_1k)$9+)tkhc9xx6n%$n!4200a(0$rnskc(9b8(n'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # Убедитесь, что путь к папке templates правильный
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
